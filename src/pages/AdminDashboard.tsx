            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start pb-4 border-b">
                  ...
                  <div>
                    <p>
                      <span className="font-medium">John Doe</span> created a
                      new account
                    </p>
                ...
                <div className="flex items-start pb-4 border-b">
                  ...
                  <div>
                    <p>
                      <span className="font-medium">Sarah Johnson</span> listed
                      a new car:{" "}
                      <span className="font-medium">2022 Toyota Camry</span>
                    </p>
                ...
                <div className="flex items-start pb-4 border-b">
                  ...
                  <div>
                    <p>
                      <span className="font-medium">Michael Chen</span> reported
                      a listing:{" "}
                      <span className="font-medium">Suspicious Price</span>
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p>
                      <span className="font-medium">Admin User</span> published
                      a new blog post:{" "}
                      <span className="font-medium">Car Maintenance Tips</span>
                    </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center pb-4 border-b">
                  <div className="flex items-center">
                    <img
                      src="https://images.unsplash.com/photo-1504215680853-026ed2a45def?w=60&h=60&fit=crop"
                      alt="Car"
                ...
                <div className="flex justify-between items-center pb-4 border-b">
                  <div className="flex items-center">
                    <img
                      src="https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=60&h=60&fit=crop"
                      alt="Car"
                      className="w-12 h-12 rounded object-cover mr-4"
                    />
                    <div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium">
                        Suspicious Price: 2018 Mercedes-Benz
                      </p>
                      <p className="text-sm text-muted-foreground">
                ...
                <div className="flex justify-between items-center pb-4 border-b">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium">
                        Misleading Information: 2021 Ford Mustang
                      </p>
                      <p className="text-sm text-muted-foreground">
...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      {/* Sidebar */}
      <div
        className={`bg-card border-r shrink-0 ${
      ...
      >
        ...
        <div className="p-4 border-t">
          <a
            href="/"
            className="flex items-center p-2 rounded-md hover:bg-accent/10"
          >
